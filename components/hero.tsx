      ...
      <section className="relative z-20 pt-55">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 -mt-27.5 md:-mt-35">
          <div data-aos="flip-left" data-aos-duration="1500">
            <div className="h-full bg-surface border border-white/5 rounded-2xl p-10 text-center shadow-[0_15px_40px_rgba(0,0,0,0.3)] hover:-translate-y-2 hover:border-blue-500/40 hover:shadow-[0_20px_50px_rgba(59,130,246,0.15)] transition-all duration-300">
