    ...
    <section id="modalidad" className="py-24 bg-background">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="bg-surface border border-white/5 border-t-4 border-t-blue-500 rounded-3xl p-10 md:p-14 text-center relative shadow-[0_20px_50px_rgba(0,0,0,0.2)] hover:shadow-[0_25px_60px_rgba(0,0,0,0.4)] transition-all duration-300">
          ...
          <div className="bg-surface border border-white/5 border-t-4 border-t-emerald-500 rounded-3xl p-10 md:p-14 text-center relative shadow-[0_20px_50px_rgba(0,0,0,0.2)] hover:shadow-[0_25px_60px_rgba(0,0,0,0.4)] transition-all duration-300">
