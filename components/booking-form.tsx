          ...
          {step === 2 && (
            <div className="flex flex-col items-center gap-6">
              ...
              <div className="grid w-full max-w-sm grid-cols-3 gap-3">
                {TIME_SLOTS.map((time) => {
                  const isBooked = isSlotOccupied(time, bookedSlots);
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "flex items-center justify-center rounded-lg border border-border bg-card px-4 py-3 text-sm font-medium transition-all",
                        isBooked
